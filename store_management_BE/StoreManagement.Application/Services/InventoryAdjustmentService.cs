...
public class InventoryAdjustmentService : IInventoryAdjustmentService
{
    ...
    public InventoryAdjustmentService(IInventoryAdjustmentRepository adjustmentRepository, IInventoryRepository inventoryRepository, IUnitOfWork unitOfWork, IMapper mapper)
    {
