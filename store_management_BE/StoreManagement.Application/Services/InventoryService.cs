...
public class InventoryService : IInventoryService
{
    ...
    public InventoryService(IInventoryRepository inventoryRepository, IUnitOfWork unitOfWork, IMapper mapper)
    {
    ...
    public async Task<List<InventoryResponse>> CreateAsync(CreateInventoryRequest request)
{
    ...
    foreach (var item in request.Items)
    {
        ...
        await _unitOfWork.SaveChangesAsync();  // Save after each item to ensure consistency
