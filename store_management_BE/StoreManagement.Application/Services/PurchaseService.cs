...
public class PurchaseService : IPurchaseService
{
    ...
    public PurchaseService(IPurchaseRepository purchaseRepository, IInventoryRepository inventoryRepository, IUnitOfWork unitOfWork, IMapper mapper)
    {
    ...
    public async Task<PurchaseResponse> CreatePurchaseAsync(CreatePurchaseRequest request, int userId)
    {
        ...
        await _unitOfWork.SaveChangesAsync(); // Lưu để lấy PurchaseId và PurchaseItemIds
